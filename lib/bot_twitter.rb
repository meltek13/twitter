...
#random_journalist = a.sample(5)
#for i in random_journalist
#client.update ("#{i} i like your twitter!!")
#end

#def like_the_25_last_#bonjour_monde
#tweets = client.search("#bonjour_monde", result_type: "recent").take(25)
#client.favorite(tweets)
#end

#def follow_the_20_last_#bonjour_monde
...
#end
#def like_and_follow_in_live_#bonjour_monde
#stream = tweetstream.SampleStream("#bonjour_monde")
#for tweet in stream
#  print tweet:
#end
#end
